...
To be able to work on G\+UI elements and translation files, the Qt Dev tools are needed\+: \begin{DoxyVerb}https://download.qt.io/archive/qt/5.12/5.12.12/qt-opensource-windows-x86-5.12.12.exe
\end{DoxyVerb}


Convert the Py\+Qt5 {\ttfamily .ui} files and generate the translation files\+: \begin{DoxyVerb}pwsh setup-environment.ps1
\end{DoxyVerb}


Download and install Qt5 from \href{https://download.qt.io/archive/qt/5.12/5.12.12/qt-opensource-windows-x86-5.12.12.exe}{\texttt{ this link}} and create the remaining files\+:
...
Finally, convert the Py\+Qt5 {\ttfamily .ui} files and generate the translation files\+: \begin{DoxyVerb}bash setup-environment.ps1
\end{DoxyVerb}
