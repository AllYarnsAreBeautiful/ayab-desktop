...
To be able to work on GUI elements and translation files, the Qt Dev tools are needed. ~\newline
 Navigate to \href{https://www.qt.io/download}{\texttt{ https\+://www.\+qt.\+io/download}} in a web browser and follow the installation instructions. From the available options, select \char`\"{}\+Custom install\char`\"{} and then \char`\"{}\+Qt 6.\+6.\+1\char`\"{}. $<$/details$>$
