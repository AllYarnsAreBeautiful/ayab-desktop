...
For information on how to install the release version of the software, see \href{http://manual.ayab-knitting.com}{\texttt{ http\+://manual.\+ayab-\/knitting.\+com}}\hypertarget{md_README_autotoc_md39}{}\doxysection{Branching Model}\label{md_README_autotoc_md39}
{\bfseries{Development of the latest and upcoming features happens on the \textquotesingle{}main\textquotesingle{} branch.}} For each major release, a dedicated maintenance branch is created to manage bug fixes, security patches, and backporting for that specific release. These branches follow the naming convention $<$version$>$-\/maint (e.\+g. {\itshape 0.\+95-\/maint}). This approach allows us to continue forward development while ensuring stability and long-\/term support for previous versions.\hypertarget{md_README_autotoc_md40}{}\doxysection{Running from Source \& Development}\label{md_README_autotoc_md40}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md43}{}\doxysubsubsection{open\+SUSE}\label{md_README_autotoc_md43}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md44}{}\doxysubsubsection{All Distributions}\label{md_README_autotoc_md44}
...
\end{DoxyCode}
 $<$/details$>$\hypertarget{md_README_autotoc_md45}{}\doxysubsection{Universal Setup Steps}\label{md_README_autotoc_md45}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md46}{}\doxysection{CI/\+CD on Git\+Hub}\label{md_README_autotoc_md46}
\hypertarget{md_README_autotoc_md47}{}\doxysubsection{Triggering a new build}\label{md_README_autotoc_md47}
...
The tag can be pushed from your local environment, or via the \href{https://github.com/AllYarnsAreBeautiful/ayab-desktop/releases/new}{\texttt{ \char`\"{}\+Draft a new Release\char`\"{}}} button on the Git\+Hub website.\hypertarget{md_README_autotoc_md48}{}\doxysubsection{Choosing the firmware release to be bundled with the build}\label{md_README_autotoc_md48}
