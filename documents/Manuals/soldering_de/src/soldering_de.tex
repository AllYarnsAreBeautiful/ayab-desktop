...
Der AYAB-Shield Bausatz enthält zwei Widerstandstypen\par
...
\textbf{ACHTUNG!} Dieser Abschnitt wird je nach Maschinentyp unterschiedlich behandelt.\par

\textbf{KH-910 / KH-950:} \par
...
Nun kann der Stecker für den Piepser wie auf Abbildung \ref{fig:abb4_1} verlötet werden. Auch hier unbedingt auf die Polarität achten.
...
\textbf{Arduino nicht im Lieferumfang enthalten}\par

Hierfür benötigen Sie folgende Steckverbinder:\par
...
\textbf{Tipp!} Stecken Sie die vier Verbindungsstecker vor dem Verlöten in die Buchsen des Arduinos (Abbildung \ref{fig:abb5_1}) und legen Sie anschließend das AYAB-Shield zum verlöten darauf (Abbildung \ref{fig:5_2}). Dies erleichtert die Lötarbeit erheblich und garantiert einen sauberen Verbau. Achten Sie jedoch auf eine möglichst kurze Lötdauer um den Arduino nicht zu beschädigen.
...
\caption{Abisolierung der Kabelenden}
\label{fig:abb7_1}
\end{figure}
...
Nun verlöten Sie das andere Ende wie auf Abbildung \ref{fig:abb7_4} mit der Platine und markieren die Oberseite des Steckers entsprechend. Dies dient zur erleichterung der Orientierung beim Einbau in die Strickmaschine\par

\begin{figure}[ht]\centering
\includegraphics[width=\linewidth]{abb7_3}
\caption{Verlötetes Kabelende}
\label{fig:abb7_3}
\end{figure}

\begin{figure}[ht]\centering
\includegraphics[width=\linewidth]{abb7_4}
\caption{Verbiundung mit Platine}
\label{fig:abb7_4}
\end{figure}
...
\textbf{KH-910 / KH-930 / KH-950 / CK-35:} \par
...
\begin{figure}[ht]\centering
\includegraphics[width=\linewidth]{abb8_3}
