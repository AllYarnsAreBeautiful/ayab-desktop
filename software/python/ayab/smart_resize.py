...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.height_spinbox, 2, 2, 1, 1)
        self.ratios_list = QtGui.QListWidget(Dialog)
        self.ratios_list.setObjectName(_fromUtf8("ratios_list"))
        self.gridLayout.addWidget(self.ratios_list, 1, 3, 4, 1)
        ...
        self.gridLayout.addWidget(self.horizontal_stitches_label, 0, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.calculated_width_label, 2, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.vertical_stitches_label, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.width_spinbox, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.calculated_height_label, 3, 5, 1, 1)
        ...
        self.ratio_spinbox = QtGui.QDoubleSpinBox(Dialog)
        self.ratio_spinbox.setObjectName(_fromUtf8("ratio_spinbox"))
        self.gridLayout.addWidget(self.ratio_spinbox, 0, 2, 1, 1)
