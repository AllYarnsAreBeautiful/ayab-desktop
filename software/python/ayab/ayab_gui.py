...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.knitting_options_dock, 4, 1, 1, 1)
        ...
        self.assistant_dock.setMinimumSize(QtCore.QSize(391, 173))
        ...
        self.label_2.setGeometry(QtCore.QRect(0, 0, 66, 21))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.pushButton = QtGui.QPushButton(self.widget_4)
        self.pushButton.setGeometry(QtCore.QRect(10, 150, 97, 31))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.lineEdit = QtGui.QLineEdit(self.widget_4)
        self.lineEdit.setGeometry(QtCore.QRect(10, 100, 113, 33))
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.pushButton_5 = QtGui.QPushButton(self.widget_4)
        self.pushButton_5.setGeometry(QtCore.QRect(10, 60, 97, 31))
        ...
        self.gridLayout.addWidget(self.assistant_dock, 3, 0, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Graphics Display", None))
