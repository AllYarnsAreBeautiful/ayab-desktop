...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.assistant_dock.setMinimumSize(QtCore.QSize(500, 248))
        ...
        self.module_dropdown.addItem(_fromUtf8(""))
        self.verticalLayout.addWidget(self.module_dropdown)
        self.label = QtGui.QLabel(self.widget)
        self.label.setObjectName(_fromUtf8("label"))
        self.verticalLayout.addWidget(self.label)
        self.serial_port_dropdown = QtGui.QComboBox(self.widget)
        ...
        self.set_serial_port_button = QtGui.QPushButton(self.widget)
        self.set_serial_port_button.setObjectName(_fromUtf8("set_serial_port_button"))
        self.verticalLayout.addWidget(self.set_serial_port_button)
        ...
        self.open_file_button = QtGui.QPushButton(self.widget_4)
        self.open_file_button.setObjectName(_fromUtf8("open_file_button"))
        self.verticalLayout_4.addWidget(self.open_file_button)
    ...
    def retranslateUi(self, Form):
        ...
        self.module_dropdown.setItemText(0, _translate("Form", "AYAB", None))
        self.label.setText(_translate("Form", "Select Serial Port", None))
        self.checkBox.setText(_translate("Form", "Active", None))
        self.set_serial_port_button.setText(_translate("Form", "Set Serial Port", None))
        self.label_2.setText(_translate("Form", "Load File", None))
        self.load_file_button.setText(_translate("Form", "Load File", None))
        self.open_file_button.setText(_translate("Form", "Open File", None))
