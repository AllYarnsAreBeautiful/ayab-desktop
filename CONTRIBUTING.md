...
1. Fork the repo and create your branch from `master` (for issues concerning the current release of the software) or from `x.x.x-dev` (for issues concerning the current development branch of the software).
