...
class SignalSender(object):
    ...
    @date   July 2020
    """
    def __init__(self, signal_receiver:SignalReceiver, *args:Any, **kwargs:Any)->None:
    ...
    def emit_progress_bar_updater(self,row:int,total:int,repeats:int,color_symbol:ColorSymbolType)->None:
        self.__signal_receiver.progress_bar_updater.emit(row,total,repeats,color_symbol)
    
    def emit_knit_progress_updater(self,status:Status,row_multiplier:int,midline:int,auto_mirror:bool)->None:
        self.__signal_receiver.knit_progress_updater.emit(status,row_multiplier,midline,auto_mirror)
    ...
    def emit_blocking_popup_displayer(self,message:str,message_type:MessageTypes)->None:
    ...
    #Meta Emitters
    def emit_blocking_popup(self, message:str="", message_type:MessageTypes="info")->None:
    ...
    def emit_popup(self, message:str="", message_type:MessageTypes="info")->None:
