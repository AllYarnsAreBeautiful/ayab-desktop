...
class Ui_MainWindow(object):
    def setupUi(self, Ui_MainWindow):
        ...
        self.image_pattern_view = QtWidgets.QGraphicsView(self.graphics_splitter)
        ...
        self.horizontal_layout.addWidget(self.label_current_color, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        ...
        self.progress_layout.addWidget(self.label_current_row, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dockWidget_contents.sizePolicy().hasHeightForWidth())
        self.dockWidget_contents.setSizePolicy(sizePolicy)
        self.dockWidget_contents.setObjectName("dockWidget_contents")
        self.vertical_layout_5 = QtWidgets.QVBoxLayout(self.dockWidget_contents)
        self.vertical_layout_5.setSizeConstraint(QtWidgets.QLayout.SetFixedSize)
        ...
        self.vertical_layout_5.addWidget(self.widget_optionsdock, 0, QtCore.Qt.AlignHCenter)
        ...
        self.vertical_layout_3.setSizeConstraint(QtWidgets.QLayout.SetMaximumSize)
        ...
        self.vertical_layout_5.addWidget(self.widget_knitcontrol, 0, QtCore.Qt.AlignHCenter)
        ...
        self.action_load_AYAB_firmware.setObjectName("action_load_AYAB_firmware")
        ...
        self.action_open_knitting_project.setObjectName("action_open_knitting_project")
    ...
    def retranslateUi(self, Ui_MainWindow):
        ...
        Ui_MainWindow.setWindowTitle(_translate("MainWindow", "All Yarns Are Beautiful"))
        ...
        self.menu_image_actions.setTitle(_translate("MainWindow", "Image Actions"))
        self.action_load_AYAB_firmware.setText(_translate("MainWindow", "Load AYAB Firmware"))
        self.action_quit.setText(_translate("MainWindow", "Quit"))
        self.action_open_knitting_project.setText(_translate("MainWindow", "Open Knitting Project"))
        ...
        self.action_horizontal_flip.setText(_translate("MainWindow", "Horizontal Flip"))
        self.action_vertical_flip.setText(_translate("MainWindow", "Vertical Flip"))
        self.action_rotate_left.setText(_translate("MainWindow", "Rotate Left"))
        self.action_rotate_right.setText(_translate("MainWindow", "Rotate Right"))
        self.action_set_preferences.setText(_translate("MainWindow", "Set Preferences"))
