...
class Ui_MainWindow(object):
    def setupUi(self, Ui_MainWindow):
        ...
        self.graphics_splitter = QtWidgets.QSplitter(self.centralwidget)
        ...
        self.menuImageActions = QtWidgets.QMenu(self.menubar)
        self.menuImageActions.setObjectName("menuImageActions")
        self.actionImageActions = QtWidgets.QAction(Ui_MainWindow)
        self.actionImageActions.setObjectName("actionImageActions")
        ...
        self.actionLoad_AYAB_Firmware = QtWidgets.QAction(Ui_MainWindow)
        self.actionLoad_AYAB_Firmware.setObjectName("actionLoad_AYAB_Firmware")
        self.actionQuit = QtWidgets.QAction(Ui_MainWindow)
        self.actionQuit.setShortcut("Ctrl+Q")
        self.actionQuit.setObjectName("actionQuit")
        self.actionOpen_Knitting_Project = QtWidgets.QAction(Ui_MainWindow)
        self.actionOpen_Knitting_Project.setObjectName("actionOpen_Knitting_Project")
        self.actionAbout = QtWidgets.QAction(Ui_MainWindow)
        self.actionAbout.setObjectName("actionAbout")
        self.actionHelp = QtWidgets.QAction(Ui_MainWindow)
        self.actionHelp.setObjectName("actionHelp")
        self.actionInvert = QtWidgets.QAction(Ui_MainWindow)
        self.actionInvert.setShortcut("Ctrl+I")
        self.actionInvert.setObjectName("actionInvert")
        self.actionStretch = QtWidgets.QAction(Ui_MainWindow)
        self.actionStretch.setShortcut("Ctrl+S")
        self.actionStretch.setObjectName("actionStretch")
        self.actionRepeat = QtWidgets.QAction(Ui_MainWindow)
        self.actionRepeat.setShortcut("Ctrl+R")
        self.actionRepeat.setObjectName("actionRepeat")
        self.actionReflect = QtWidgets.QAction(Ui_MainWindow)
        self.actionReflect.setShortcut("Ctrl+M")
        self.actionReflect.setObjectName("actionReflect")
        self.actionHorizontalFlip = QtWidgets.QAction(Ui_MainWindow)
        self.actionHorizontalFlip.setShortcut("Ctrl+Up")
        self.actionHorizontalFlip.setObjectName("actionHorizontalFlip")
        self.actionVerticalFlip = QtWidgets.QAction(Ui_MainWindow)
        self.actionVerticalFlip.setShortcut("Ctrl+Down")
        self.actionVerticalFlip.setObjectName("actionVerticalFlip")
        self.actionRotateLeft = QtWidgets.QAction(Ui_MainWindow)
        self.actionRotateLeft.setShortcut("Ctrl+Left")
        self.actionRotateLeft.setObjectName("actionRotateLeft")
        self.actionRotateRight = QtWidgets.QAction(Ui_MainWindow)
        self.actionRotateRight.setShortcut("Ctrl+Right")
        self.actionRotateRight.setObjectName("actionRotateRight")
        self.actionSetPreferences = QtWidgets.QAction(Ui_MainWindow)
        ...
        self.menuImageActions.addAction(self.actionInvert)
        self.menuImageActions.addAction(self.actionStretch)
        self.menuImageActions.addAction(self.actionRepeat)
        self.menuImageActions.addAction(self.actionReflect)
        self.menuImageActions.addSeparator()
        self.menuImageActions.addAction(self.actionHorizontalFlip)
        self.menuImageActions.addAction(self.actionVerticalFlip)
        self.menuImageActions.addSeparator()
        self.menuImageActions.addAction(self.actionRotateLeft)
        self.menuImageActions.addAction(self.actionRotateRight)
        self.menuImageActions.addSeparator()
    ...
    def retranslateUi(self, Ui_MainWindow):
        ...
        self.menuImageActions.setTitle(_translate("MainWindow", "Image Actions"))
        ...
        self.actionHorizontalFlip.setText(_translate("MainWindow", "Horizontal Flip"))
        self.actionVerticalFlip.setText(_translate("MainWindow", "Vertical Flip"))
