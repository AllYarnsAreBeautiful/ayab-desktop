...
class TestAYABControl(unittest.TestCase):
    ...
    def test__circular_ribber(self):
        ...
        ayab_control.__startLine = 0
        ayab_control.__infRepeat = True
        assert ayab_control._circular_ribber( 0,3,18) == (0,0, 0,False,False)
        assert ayab_control._circular_ribber( 1,3,18) == (0,0, 0,False,True )
        assert ayab_control._circular_ribber( 2,3,18) == (0,1, 1,False,False)
        assert ayab_control._circular_ribber( 3,3,18) == (0,1, 1,False,True )
        assert ayab_control._circular_ribber( 4,3,18) == (0,2, 2,False,False)
        assert ayab_control._circular_ribber( 5,3,18) == (0,2, 2,False,True )
        assert ayab_control._circular_ribber( 6,3,18) == (1,0, 3,False,False)
        assert ayab_control._circular_ribber( 7,3,18) == (1,0, 3,False,True )
        assert ayab_control._circular_ribber( 8,3,18) == (1,1, 4,False,False)
        assert ayab_control._circular_ribber( 9,3,18) == (1,1, 4,False,True )
        assert ayab_control._circular_ribber(10,3,18) == (1,2, 5,False,False)
        assert ayab_control._circular_ribber(11,3,18) == (1,2, 5,False,True )
        assert ayab_control._circular_ribber(12,3,18) == (2,0, 6,False,False)
        assert ayab_control._circular_ribber(13,3,18) == (2,0, 6,False,True )
        assert ayab_control._circular_ribber(14,3,18) == (2,1, 7,False,False)
        assert ayab_control._circular_ribber(15,3,18) == (2,1, 7,False,True )
        assert ayab_control._circular_ribber(16,3,18) == (2,2, 8,False,False)
        assert ayab_control._circular_ribber(17,3,18) == (2,2, 8,False,True )
        assert ayab_control._circular_ribber(18,3,18) == (0,0, 0,False,False)
