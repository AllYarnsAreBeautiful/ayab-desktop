...
class TestAYABControl(unittest.TestCase):
    ...
    def test__singlebed_2col(self):
        ...
        assert ayab_control._singlebed_2col(2,3,6) == (0,0,0,False,False)
    ...
    def test__doublebed_2col(self):
        ...
        ayab_control._startLine = 1
        assert ayab_control._doublebed_2col( 8,5,10) == (0,1,1,False,False)
    ...
    def test__doublebed_multicol(self):
        ...
        ayab_control._startLine = 1
        assert ayab_control._doublebed_multicol(12,3,9) == (0,0,0,False,False)
    ...
    def test__middlecoltwice(self):
        ...
        ayab_control._startLine = 1
        assert ayab_control._middlecoltwice(16,5,15) == (0,1, 1,False,False)
    ...
    def test__heartofpluto(self):
        ...
        assert ayab_control._heartofpluto( 4,5,15) == (1,0, 3,False,False)
        assert ayab_control._heartofpluto( 5,5,15) == (1,2, 5,False,False)
        assert ayab_control._heartofpluto( 6,5,15) == (1,2, 5,True ,False)
        assert ayab_control._heartofpluto( 7,5,15) == (1,1, 4,False,False)
        assert ayab_control._heartofpluto( 8,5,15) == (2,1, 7,False,False)
        assert ayab_control._heartofpluto( 9,5,15) == (2,0, 6,False,False)
        assert ayab_control._heartofpluto(10,5,15) == (2,0, 6,True ,False)
        assert ayab_control._heartofpluto(11,5,15) == (2,2, 8,False,False)
        assert ayab_control._heartofpluto(12,5,15) == (3,2,11,False,False)
        assert ayab_control._heartofpluto(13,5,15) == (3,1,10,False,False)
        assert ayab_control._heartofpluto(14,5,15) == (3,1,10,True ,False)
        ...
        assert ayab_control._heartofpluto(23,5,15) == (0,2, 2,False,False)
        assert ayab_control._heartofpluto(24,5,15) == (1,2, 5,False,False)
        ayab_control._startLine = 1
        assert ayab_control._heartofpluto(16,5,15) == (0,1, 1,False,False)
    ...
    def test__circular_ribber(self):
        ...
        ayab_control._startLine = 1
        assert ayab_control._circular_ribber(12,3,9) == (0,0, 0,False,False)
