...
class Ui_MenuBar(object):
    ...
    def retranslateUi(self, menubar):
        ...
        self.action_horizontal_flip.setText(
            _translate("MenuBar", "Horizontal Flip"))
        self.action_vertical_flip.setText(
            _translate("MenuBar", "Vertical Flip"))
