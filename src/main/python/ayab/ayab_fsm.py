...
class FSM (object):
    ...
    def transitions(self):
        ...
        self.NO_IMAGE.addTransition(self.__parent.signal_image_loaded, self.NOT_CONFIGURED)
        self.NOT_CONFIGURED.addTransition(self.__parent.ui.knit_button.clicked, self.CONFIGURING)
        self.CONFIGURING.addTransition(self.__parent.signal_image_loaded, self.NOT_CONFIGURED)
        self.CONFIGURING.addTransition(self.__parent.signal_image_transformed, self.NOT_CONFIGURED)
        self.CONFIGURING.addTransition(self.__parent.signal_configure_fail, self.NOT_CONFIGURED)
        self.CONFIGURING.addTransition(self.__parent.signal_configured, self.KNITTING)
