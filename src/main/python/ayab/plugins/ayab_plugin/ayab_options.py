...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.machine_type_box.setItemText(0, "Singlebed")
        self.machine_type_box.addItem("")
        self.machine_type_box.setItemText(1, "Ribber: Classic")
        self.machine_type_box.addItem("")
        self.machine_type_box.addItem("")
    ...
    def retranslateUi(self, DockWidget):
        ...
        self.machine_type_box.setItemText(2, _translate("DockWidget", "Ribber: Middle-Colors-Twice"))
