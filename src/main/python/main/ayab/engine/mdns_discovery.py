...
class MdnsBrowser:
    ...
    def __init__(self, service_type: str):
        ...
        self.listener = self._ZeroconfListener(self)
    ...
    class _ZeroconfListener:
        ...
        def add_service(self, zeroconf_instance: zeroconf.Zeroconf, type: str, name: str):
            self.parent_browser._on_service_changed(zeroconf_instance, type, name, "added")

        def update_service(self, zeroconf_instance: zeroconf.Zeroconf, type: str, name: str):
            self.parent_browser._on_service_changed(zeroconf_instance, type, name, "updated")

        def remove_service(self, zeroconf_instance: zeroconf.Zeroconf, type: str, name: str):
            self.parent_browser._on_service_removed(zeroconf_instance, type, name)

    def _on_service_changed(self, zeroconf_instance: zeroconf.Zeroconf, type: str, name: str, change_type: str):
        """Callback called when a service is added or updated."""
        info = zeroconf.ServiceInfo(type, name)
        try:
    ...
    def _on_service_removed(self, zeroconf_instance: zeroconf.Zeroconf, type: str, name: str):
    ...
    def _on_service_updated(self, zeroconf_instance: zeroconf.Zeroconf, type: str, name: str):
